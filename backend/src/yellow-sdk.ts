...
export class YellowSDK {
   ...
   * Note: Must encode as a tuple (struct) for Solidity abi.decode to work correctly
   */
  buildExecutionData(
    agentId: bigint,
    quote: YellowQuote,
    ...
    // Encode as a tuple (struct) - this adds the offset pointer that Solidity expects
